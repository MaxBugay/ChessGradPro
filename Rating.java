 ...
 * @author Max
 */
public class Rating { //Rates AI and Human Moves
    static int pawnBoard[][]={//from http://chessprogramming.wikispaces.com/Simplified+evaluation+function
        { 0,  0,  0,  0,  0,  0,  0,  0},
    ...
    public static int rateAttack() {
        ...
        for (int i=0;i<64;i++) {
            switch (AlphaBetaChess.chessBoard[i/8][i%8]) {
                case "P": {AlphaBetaChess.kingPositionC=i; if (!AlphaBetaChess.kingSafe()) {counter-=100;}}
                    break;
    ...
    public static int rateMaterial() {
        ...
        for (int i=0;i<64;i++) {
            switch (AlphaBetaChess.chessBoard[i/8][i%8]) {
                ...
                case "K": counter+=300;
                    break;
                case "B": bishopCounter+=1; //each bishop is always on their color 
                    break;
                case "Q": counter+=900;
                    break;
            }
    ...
    public static int ratePositional(int material ) { //material tells the pieces you loss
        int counter=0;
        for (int i=0;i<64;i++) {
            switch (AlphaBetaChess.chessBoard[i/8][i%8]) {
